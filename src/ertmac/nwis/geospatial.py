...
class GeospatialIntelligence:
    ...
    def find_nearby_wells(self, active_well_id: str, organization_id: str, radius_km: float = 5.0) -> List[Dict[str, Any]]:
        ...
        for w_id, w_info in self.coords.items():
            ...
            if lat is None or lon is None or w_info.get("organization_id", "00000000-0000-0000-0000-000000000001") != organization_id:
                continue
